...
public class FavouriteControllerTest {
	...
	private transient Favourite favourite;
	static List<Favourite> listFav;
	String var =" {\n" + 
			"            \"artists\": [\n" + 
			"              {\n" + 
			"                \"external_urls\": {\n" + 
	...
	public void setUp() throws Exception {
		...
		mvc = MockMvcBuilders.standaloneSetup(favouriteController).build();
		favourite = new Favourite(new ObjectId("5e68b690226fc421d1395699"),"hi@gmail.com","53A0W3U0s8diEn9hXV",null);
	}
	@Test
	public void testInsertRecommendationFailure() throws Exception{
		//System.out.println("recommendation");
		Mockito.when(service.addFavourite(favourite)).thenReturn(favourite);
        mvc.perform(MockMvcRequestBuilders.post("/musix/favourite/add").contentType(MediaType.APPLICATION_JSON).content(jsonToString(favourite)))
...
//                .andExpect(MockMvcResultMatchers.status().isOk());
	...
	public void testdeleteRecommendationByIdFailure() throws Exception{
		when(service.deleteFavourite(favourite)).thenReturn(true);
		mvc.perform(delete("/musix/favourite/53A0W3U0s8diEn9hXV/hi@gmail.com",1)).andExpect(status().isBadRequest());
