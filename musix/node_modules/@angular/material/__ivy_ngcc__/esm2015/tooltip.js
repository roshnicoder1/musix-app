...
MatTooltip.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatTooltip, selectors: [["", "matTooltip", ""]], hostBindings: function MatTooltip_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("longpress", function MatTooltip_longpress_HostBindingHandler($event) { return ctx.show(); })("keydown", function MatTooltip_keydown_HostBindingHandler($event) { return ctx._handleKeydown($event); })("touchend", function MatTooltip_touchend_HostBindingHandler($event) { return ctx._handleTouchend(); });
