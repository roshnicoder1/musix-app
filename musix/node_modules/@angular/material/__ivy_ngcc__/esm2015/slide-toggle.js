...
MatSlideToggle.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatSlideToggle, selectors: [["mat-slide-toggle"]], viewQuery: function MatSlideToggle_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵlistener("slidestart", function MatSlideToggle_Template_div_slidestart_6_listener($event) { return ctx._onDragStart(); })("slide", function MatSlideToggle_Template_div_slide_6_listener($event) { return ctx._onDrag($event); })("slideend", function MatSlideToggle_Template_div_slideend_6_listener($event) { return ctx._onDragEnd(); });
